package projects.jatin.chatexpress.Holder;
...
/**
 * Created by Jateen on 07-08-2017.
 */
...
public class QBChatMessagesHolder {
    ...
    public ArrayList<QBChatMessage> getChatMessagesByDialogId(String dialdogId)
    {
        return (ArrayList<QBChatMessage>)this.qbChatMessageArray.get(dialdogId);
    }
}
