...
import projects.jatin.chatexpress.Adapter.ListUsersAdapter;
            ...
            public void onClick(View v) {
                ...
                if (mode == null) {
                    ...
                    if (lstUsers.getCheckedItemPositions().size() == 1)
                        ...
                        Toasty.info(ListUsersActivity.this, "Please select friend to chat.", Toast.LENGTH_SHORT).show();
                }
                        ...
                        QBRestChatService.updateGroupChatDialog(qbChatDialog,requestBuilder)
                                .performAsync(new QBEntityCallback<QBChatDialog>() {
                                    ...
                                    public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                                        Toasty.success(ListUsersActivity.this, "User added successfully.", Toast.LENGTH_SHORT).show();
                                        finish();
                                    }
                                    ...
                                    public void onError(QBResponseException e) {
                                        ...
                                        Toasty.error(ListUsersActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                    ...
                    if(userAdd.size()>0)
                    {
                        ...
                        QBRestChatService.updateGroupChatDialog(qbChatDialog,requestBuilder)
                                .performAsync(new QBEntityCallback<QBChatDialog>() {
                                    @Override
                                    public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                                        Toasty.success(ListUsersActivity.this, "User removed successfully.", Toast.LENGTH_SHORT).show();
                                        finish();
                                    }
        ...
        QBRestChatService.getChatDialogById(qbChatDialog.getDialogId())
                .performAsync(new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                        ...
                        //Remove all user already in group chat
    ...
    private void createGroupChat(SparseBooleanArray checkedItemPositions){
        ...
        QBRestChatService.createChatDialog(dialog).performAsync(new QBEntityCallback<QBChatDialog>() {
            ...
            public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                ...
                mDialog.dismiss();
                Toasty.success(ListUsersActivity.this, "Chat dialog created successfully.", Toast.LENGTH_SHORT).show();


                //Send system message to reciept Id user
            ...
            if(checkedItemPositions.get(i))
            {
                ...
                QBRestChatService.createChatDialog(dialog).performAsync(new QBEntityCallback<QBChatDialog>() {
                    ...
                    public void onSuccess(QBChatDialog qbChatDialog, Bundle bundle) {
                        ...
                        mDialog.dismiss();
                        Toasty.success(ListUsersActivity.this, "Private chat dialog created successfully.", Toast.LENGTH_SHORT).show();
...
//        QBUser qbUser=lstUsers.getItemAtPosition
